...
public class SubtopiServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
     ...
     // String topic_id = req.getParameter("topic_id");
      String[] selectedTopics = req.getParameterValues("topic_id");
      String topic_id = ""; // Initialize or handle multiple selections as per your logic
      if (selectedTopics != null && selectedTopics.length > 0) {
          topic_id = selectedTopics[0]; // Assuming single selection, modify logic for multiple selections
      }
