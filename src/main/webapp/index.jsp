  ...
  <script src="https://cdn.jsdelivr.net/npm/string-similarity@4.0.4/umd/string-similarity.min.js"></script>
   ...
   <script src="js/micScript.js"></script>
    ...
    var dataset = [
      ...
      {
        message: 'take me the login page',
        intent: 'login'
      },
      {
        message: 'I would like to login',
        intent: 'login'
      },
      {
        message: 'I would like to login into the web site',
        intent: 'login'
      },
      {
        message: 'show me the question page',
        intent: 'question'
      },
      {
        message: 'goto question page',
        intent: 'question'
      },
      {
      ...
      {
        message: 'take me the question page',
        intent: 'question'
      },
      {
        message: 'I want to create a question',
        intent: 'question'
      },
      {
        message: 'I would like to create a question',
        intent: 'question'
      },
      {
        message: 'I would like to edit questions',
        intent: 'edit_question'
      },
      {
        message: 'I would like to change questions',
        intent: 'edit_question'
      },
      {
        message: 'I would like to modify questions',
        intent: 'edit_question'
      },
      {
        message: 'I would like to alter questions',
        intent: 'edit_question'
      },
      {
        message: 'go to alter questions',
        intent: 'edit_question'
      },
      {
        message: 'go to modify questions',
        intent: 'edit_question'
      }
    ...
    function classifyIntent(userInput, dataset) {
      const similarityThreshold = 0.5;
      let bestMatch = null;
      let bestScore = 0;

      dataset.forEach(item => {
        const similarityScore = calculateSimilarity(userInput, item.message);

        if (similarityScore > similarityThreshold && similarityScore > bestScore) {
          bestMatch = item;
    ...
    function calculateSimilarity(str1, str2) {
      ...
      return similarity;
        ...
        $(document).ready(function () {
            ...
            $(".mic_btn").click(function () {
                ...
                if ($( '#pulse-ring' ).is( ':visible' ) ) {
                    console.log("visible to hide");
                    $("#pulse-ring").hide();
                } else {
                    console.log("hide to visible");
                    $("#pulse-ring").show();
                    recognition.start();
        ...
        recognition.onresult = function(event) {
            ...
            const result = classifyIntent(input, dataset);
        ...
        <div class="container">
            <nav class="navbar navbar-dark navbar-expand-lg py-0">
                ...
                <div class="d-none d-xl-flex flex-shirink-0">
                    ...
                    <div class="container d-flex align-items-center justify-content-center ms-4">
                        <button id="speech" class="mic_btn">
                            <div id="pulse-ring" class="pulse-ring" style="display: none;" ></div>
        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item">
                    <img src="img/index-2.jpg" class="img-fluid" alt="Second slide">
                    <div class="carousel-caption">
                        <div class="container carousel-content">
                            <h6 class="text-secondary h4 animated fadeInUp">Best IT Solutions</h6>
