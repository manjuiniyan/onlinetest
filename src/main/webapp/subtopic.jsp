...
<body>
    ...
    <div class="container-fluid page-header py-5">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Add SubTopic</h1>

            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="p-2 rounded contact-form fadeIn" data-wow-delay=".5s">

                      <form action="SubTopicServlet" method="post" class="row g-3 needs-validation" novalidate>
                               <div class="mb-4">
                               <select name="topic_id" class="form-control border-0 py-3">
                                  <!-- Populate options dynamically based on topics -->
                                 <option value="topic_id_1">Topic 1</option>
                                 <option value="topic_id_2">Topic 2</option>
                                  <!-- Add options for other topics -->
                             </select>
                              </div>
                               <div class="mb-4">
                                  <input type="text" name="sub_topic_id" class="form-control border-0 py-3" placeholder="SubTopic ID" >
                                </div>
                            <!--     <div class="mb-4">
                                 <input type="text" name="topic_id" class="form-control border-0 py-3" placeholder="Topic ID" >
                                  </div>   -->
                                <div class="mb-4">
                                    <input type="text" name="sub_topic_name" class="form-control border-0 py-3" placeholder="SubTopic Name">
                                </div>
