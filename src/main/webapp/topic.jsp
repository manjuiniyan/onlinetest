...
<body>
    ...
    <div class="container-fluid page-header py-5">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Add Topics</h1>
                ...
                <div class="col-lg-6">
                    <div class="p-2 rounded contact-form fadeIn" data-wow-delay=".5s">
                        ...
                        <form action="TopicServlet" method="post" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="mb-4">
                                    <input type="text" name="topic_id" class="form-control border-0 py-3" placeholder="Topic_ID" >
                                </div>
                                <div class="mb-4">
