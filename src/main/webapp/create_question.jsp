    ...
    <body>
        ...
        <div class="container-fluid bg-dark py-2 d-none d-md-flex">
            <div class="container">
              ...
              >
                            gurukalvi.system@gmail.com
                        </small>
                    </div>
                    <div id="note" class="text-secondary d-none d-xl-flex">
                        <small>Note : Start Learning for your future</small>
                    </div>
                    <div class="top-link">
                ...
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        <div class="navbar-nav ms-auto mx-xl-auto p-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle active text-secondary" data-bs-toggle="dropdown">
                                    Test
                                </a>
                                <div class="dropdown-menu rounded">
                            ...
                            <a href="#" class="nav-item nav-link" onclick="logout()" id="logoutSection" style="display: none;">Logout</a>
                        </div>
                        ...
                        <div class="p-2 rounded contact-form fadeIn" data-wow-delay=".5s">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="text-start d-flex justify-content-center">
                                    <button class="btn btn-dark text-white py-3 px-5" type="submit">
                                        Submit +
                                    </button>
                                    &nbsp;
                                    <button class="btn btn-dark text-white py-3 px-5" type="submit">
                                    ...
                                    &nbsp;
                                    <button class="btn btn-dark text-white py-3 px-5" type="reset">
                                        Reset
                                    </button>
                                    &nbsp;
                                </div>
